...
typedef enum {
    STRICT_SK_SRC_RECT_CONSTRAINT,
    FAST_SK_SRC_RECT_CONSTRAINT
...
typedef struct {
    const int fMaxAniso;
    const bool fUseCubic;
    const sk_cubic_resampler_t fCubic;
    const sk_filter_mode_t fFilter;
    const sk_mipmap_mode_t fMipmap;
...
typedef enum {
    ...
    FLOAT3_UNIFORM_TYPE,
    FLOAT4_UNIFORM_TYPE,
    FLOAT_2X2_UNIFORM_TYPE,
    FLOAT_3X3_UNIFORM_TYPE,
    FLOAT_4X4_UNIFORM_TYPE,
    INT_UNIFORM_TYPE,
    INT2_UNIFORM_TYPE,
    INT3_UNIFORM_TYPE,
    INT4_UNIFORM_TYPE,
...
typedef enum {
    SHADER_CHILD_TYPE,
    COLORFILTER_CHILD_TYPE,
    BLENDER_CHILD_TYPE,
} sk_runtimeeffect_child_type_t;

typedef struct sk_runtimeeffect_t sk_runtimeeffect_t;
typedef struct sk_runtime_effect_builder_t sk_runtime_effect_builder_t;
typedef struct sk_runtime_shader_builder_t sk_runtime_shader_builder_t;
typedef struct sk_runtime_blender_builder_t sk_runtime_blender_builder_t;
typedef struct sk_runtimeeffect_uniform_t sk_runtimeeffect_uniform_t;
typedef struct sk_runtimeeffect_child_t sk_runtimeeffect_child_t;
