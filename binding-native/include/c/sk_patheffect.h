...
SK_C_API sk_data_t* sk_path_effect_serialize(const sk_path_effect_t* patheffect);
SK_C_API sk_path_effect_t* sk_path_effect_deserialize(const sk_data_t* data);
