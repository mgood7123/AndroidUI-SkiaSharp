...
SK_C_API void sk_canvas_concat44(sk_canvas_t*, const sk_m44_t*);
...
SK_C_API void sk_canvas_draw_image(sk_canvas_t*, const sk_image_t*, float x, float y, const sk_sampling_options_t* sampling_options, const sk_paint_t*);
SK_C_API void sk_canvas_draw_image_rect_with_constraint(sk_canvas_t* ccanvas, const sk_image_t* cimage, const sk_rect_t* csrcR, const sk_rect_t* cdstR, const sk_sampling_options_t* sampling_options, const sk_paint_t* cpaint, sk_src_rect_constraint_t constraint);
...
SK_C_API void sk_canvas_draw_slug(sk_canvas_t*, sk_slug_t* slug);
...
SK_C_API void sk_canvas_set_matrix44(sk_canvas_t* ccanvas, const sk_m44_t* matrix);
SK_C_API void sk_canvas_get_total_matrix(sk_canvas_t* ccanvas, sk_matrix_t* matrix);
SK_C_API void sk_canvas_get_total_matrix44(sk_canvas_t* ccanvas, sk_m44_t* matrix);
...
SK_C_API void sk_canvas_draw_image_lattice(sk_canvas_t* ccanvas, const sk_image_t* image, const sk_lattice_t* lattice, const sk_rect_t* dst, sk_filter_mode_t filter, const sk_paint_t* paint);
...
SK_C_API void sk_canvas_draw_atlas(sk_canvas_t* ccanvas, const sk_image_t* atlas, const sk_rsxform_t* xform, const sk_rect_t* tex, const sk_color_t* colors, int count, sk_blendmode_t mode, const sk_sampling_options_t* sampling_options, const sk_rect_t* cullRect, const sk_paint_t* paint);
