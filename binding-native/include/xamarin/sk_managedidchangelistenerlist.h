...
SK_X_API void sk_managedidchangelistenerlist_add(sk_idchangelistenerlist_t*, sk_idchangelistener_t*);
SK_X_API int32_t sk_managedidchangelistenerlist_count(sk_idchangelistenerlist_t*);
SK_X_API void sk_managedidchangelistenerlist_changed(sk_idchangelistenerlist_t*);
SK_X_API void sk_managedidchangelistenerlist_reset(sk_idchangelistenerlist_t*);
