...
DEF_CLASS_MAP(SkRuntimeEffectBuilder, sk_runtime_effect_builder_t, RuntimeEffectBuilder)
DEF_CLASS_MAP(SkRuntimeShaderBuilder, sk_runtime_shader_builder_t, RuntimeShaderBuilder)
DEF_CLASS_MAP(SkRuntimeBlendBuilder, sk_runtime_blender_builder_t, RuntimeBlenderBuilder)
