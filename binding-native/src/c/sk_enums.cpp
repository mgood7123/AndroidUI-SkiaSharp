...
#define ASSERT_MSG(SK, C) "ABI changed, you must update the C enum for " SK_TO_STRING(#C) " in sk_types.h based on the current C++ enum of " SK_TO_STRING(#SK) "."
...
static_assert ((int)SkCodecAnimation::Blend::kSrcOver == (int)SRC_OVER_BLEND_MODE_CODEC, ASSERT_MSG(SkCodecAnimation::Blend, sk_codecanimation_blend_t));
static_assert ((int)SkCodecAnimation::Blend::kSrc == (int)SRC_BLEND_MODE_CODEC, ASSERT_MSG(SkCodecAnimation::Blend, sk_codecanimation_blend_t));

// sk_canvas_src_rect_constraint_t
static_assert ((int)SkCanvas::SrcRectConstraint::kStrict_SrcRectConstraint == (int)STRICT_SK_SRC_RECT_CONSTRAINT, ASSERT_MSG(SkCanvas::SrcRectConstraint, sk_src_rect_constraint_t));
static_assert ((int)SkCanvas::SrcRectConstraint::kFast_SrcRectConstraint == (int)FAST_SK_SRC_RECT_CONSTRAINT, ASSERT_MSG(SkCanvas::SrcRectConstraint, sk_src_rect_constraint_t));

// sk_runtimeeffect_uniform_type_t
static_assert ((int)SkRuntimeEffect::Uniform::Type::kFloat == (int)FLOAT_UNIFORM_TYPE, ASSERT_MSG(SkRuntimeEffect::Uniform::Type, sk_runtimeeffect_uniform_type_t));
static_assert ((int)SkRuntimeEffect::Uniform::Type::kFloat2 == (int)FLOAT2_UNIFORM_TYPE, ASSERT_MSG(SkRuntimeEffect::Uniform::Type, sk_runtimeeffect_uniform_type_t));
static_assert ((int)SkRuntimeEffect::Uniform::Type::kFloat3 == (int)FLOAT3_UNIFORM_TYPE, ASSERT_MSG(SkRuntimeEffect::Uniform::Type, sk_runtimeeffect_uniform_type_t));
static_assert ((int)SkRuntimeEffect::Uniform::Type::kFloat4 == (int)FLOAT4_UNIFORM_TYPE, ASSERT_MSG(SkRuntimeEffect::Uniform::Type, sk_runtimeeffect_uniform_type_t));
static_assert ((int)SkRuntimeEffect::Uniform::Type::kFloat2x2 == (int)FLOAT_2X2_UNIFORM_TYPE, ASSERT_MSG(SkRuntimeEffect::Uniform::Type, sk_runtimeeffect_uniform_type_t));
static_assert ((int)SkRuntimeEffect::Uniform::Type::kFloat3x3 == (int)FLOAT_3X3_UNIFORM_TYPE, ASSERT_MSG(SkRuntimeEffect::Uniform::Type, sk_runtimeeffect_uniform_type_t));
static_assert ((int)SkRuntimeEffect::Uniform::Type::kFloat4x4 == (int)FLOAT_4X4_UNIFORM_TYPE, ASSERT_MSG(SkRuntimeEffect::Uniform::Type, sk_runtimeeffect_uniform_type_t));
static_assert ((int)SkRuntimeEffect::Uniform::Type::kInt == (int)INT_UNIFORM_TYPE, ASSERT_MSG(SkRuntimeEffect::Uniform::Type, sk_runtimeeffect_uniform_type_t));
static_assert ((int)SkRuntimeEffect::Uniform::Type::kInt2 == (int)INT2_UNIFORM_TYPE, ASSERT_MSG(SkRuntimeEffect::Uniform::Type, sk_runtimeeffect_uniform_type_t));
static_assert ((int)SkRuntimeEffect::Uniform::Type::kInt3 == (int)INT3_UNIFORM_TYPE, ASSERT_MSG(SkRuntimeEffect::Uniform::Type, sk_runtimeeffect_uniform_type_t));
static_assert ((int)SkRuntimeEffect::Uniform::Type::kInt4 == (int)INT4_UNIFORM_TYPE, ASSERT_MSG(SkRuntimeEffect::Uniform::Type, sk_runtimeeffect_uniform_type_t));

static_assert ((int)SkRuntimeEffect::ChildType::kShader == (int)SHADER_CHILD_TYPE, ASSERT_MSG(SkRuntimeEffect::ChildType, sk_runtimeeffect_child_type_t));
static_assert ((int)SkRuntimeEffect::ChildType::kColorFilter == (int)COLORFILTER_CHILD_TYPE, ASSERT_MSG(SkRuntimeEffectChild::Type, sk_runtimeeffect_child_type_t));
static_assert ((int)SkRuntimeEffect::ChildType::kBlender == (int)BLENDER_CHILD_TYPE, ASSERT_MSG(SkRuntimeEffect::ChildType, sk_runtimeeffect_child_type_t));
