...
namespace SkiaSharp
{
	...
	public unsafe abstract class SKPngChunkReader : SKObject, ISKSkipObjectRegistration
	{
		...
		protected SKManagedPngChunkReader()
		...
		public abstract bool readChunk(char[] tag, IntPtr data, IntPtr length);

		// impl

		[MonoPInvokeCallback(typeof(SKManagedPngChunkReaderReadChunkProxyDelegate))]
		private static bool ReadChunkInternal(IntPtr d, void* context, char[] tag, IntPtr data, IntPtr length)
		{
